...
const items = ref(["Marzo", "Abril", "Mayo", "Junio"]);
</script>
    ...
    <v-card elevation="10">
        <v-card-text>
            <div class="d-sm-flex align-start">
                <div>
                    <h2 class="text-h4">Dashboard Satisfaccion al Cliente</h2>
                </div>
                <v-spacer></v-spacer>
                <div class="ml-auto">
            ...
            <div class="d-flex justify-center">
                <div class="d-flex align-center text-primary px-2">
                    ...
                    <span class="font-weight-regular">Satisfactorio</span>
                </div>
                <div class="d-flex align-center px-2 text-secondary">
                    <span class="text-overline">
                        <i class="mdi mdi-brightness-1 mx-1"></i>
                    </span>
                    <span class="font-weight-regular">No Satisfactorio</span>
                </div>
            </div>
        </v-card-text>
    </v-card>
